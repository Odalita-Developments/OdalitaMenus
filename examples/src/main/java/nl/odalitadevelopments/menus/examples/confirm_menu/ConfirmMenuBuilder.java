...
public sealed interface ConfirmMenuBuilder permits ConfirmMenuBuilderImpl {
    ...
    @NotNull ConfirmMenuBuilder buttonSize(@NotNull ConfirmMenu.ButtonSize buttonSize);
    ...
    @NotNull ConfirmMenuBuilder globalCacheKey(@NotNull String globalCacheKey);

    void open(@NotNull JavaPlugin plugin, @NotNull Player player);
}