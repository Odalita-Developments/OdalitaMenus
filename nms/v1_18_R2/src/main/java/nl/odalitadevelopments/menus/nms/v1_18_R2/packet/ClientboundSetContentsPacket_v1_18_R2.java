package nl.odalitadevelopments.menus.nms.v1_18_R2.packet;
...
import nl.odalitadevelopments.menus.nms.v1_18_R2.ObfuscatedNames_v1_18_R2;
...
public final class ClientboundSetContentsPacket_v1_18_R2 implements ClientboundSetContentsPacket {
    ...
    static {
        ITEMS_FIELD = Reflections.getField(ClientboundContainerSetContentPacket.class, List.class, ObfuscatedNames_v1_18_R2.SET_CONTENTS_PACKET_ITEMS);
        CARRIED_ITEM_FIELD = Reflections.getField(ClientboundContainerSetContentPacket.class, net.minecraft.world.item.ItemStack.class, ObfuscatedNames_v1_18_R2.SET_CONTENTS_PACKET_CARRIED_ITEM);
    }
    ...
    public ClientboundSetContentsPacket_v1_18_R2(ClientboundContainerSetContentPacket packet) {
        this.packet = packet;
