...
import nl.odalitadevelopments.menus.nms.v1_21_R2.packet.ClientboundSetContentsPacket_v1_21_R2;
import nl.odalitadevelopments.menus.nms.v1_21_R2.packet.ClientboundSetSlotPacket_v1_21_R2;
...
public final class OdalitaMenusNMS_v1_21_R2 implements OdalitaMenusNMS {
    ...
    static {
        try {
            ...
            WINDOW_ID_FIELD = AbstractContainerMenu.class.getDeclaredField(ObfuscatedNames_v1_21_R2.WINDOW_ID);
            NETWORK_MANAGER_FIELD = ServerCommonPacketListenerImpl.class.getDeclaredField(ObfuscatedNames_v1_21_R2.NETWORK_MANAGER);
    ...
    public ClientboundSetSlotPacket readSetSlotPacket(Object packet) {
        ...
        return new ClientboundSetSlotPacket_v1_21_R2(clientboundContainerSetSlotPacket);
    }
    ...
    public ClientboundSetContentsPacket readSetContentsPacket(Object packet) {
        ...
        return new ClientboundSetContentsPacket_v1_21_R2(clientboundContainerSetContentPacket);
    }
