package nl.odalitadevelopments.menus.nms.v1_21_R5.packet;
...
import nl.odalitadevelopments.menus.nms.v1_21_R5.ObfuscatedNames_v1_21_R5;
...
public final class ClientboundSetContentsPacket_v1_21_R5 implements ClientboundSetContentsPacket {
...
//    private static final Reflections.FieldAccessor<net.minecraft.world.item.ItemStack> CARRIED_ITEM_FIELD;
    ...
    static {
//        TODO: this does not work, ClientboundContainerSetContentPacket is now a record and fields cannot be modifier. Fix!
//        ITEMS_FIELD = Reflections.getField(ClientboundContainerSetContentPacket.class, List.class, ObfuscatedNames_v1_21_R5.SET_CONTENTS_PACKET_ITEMS);
//        CARRIED_ITEM_FIELD = Reflections.getField(ClientboundContainerSetContentPacket.class, net.minecraft.world.item.ItemStack.class, ObfuscatedNames_v1_21_R5.SET_CONTENTS_PACKET_CARRIED_ITEM);
    }
    ...
    public ClientboundSetContentsPacket_v1_21_R5(ClientboundContainerSetContentPacket packet) {
        this.packet = packet;
