...
public final class ClientboundSetContentsPacket_v1_21_R7 implements ClientboundSetContentsPacket {

    private final ClientboundContainerSetContentPacket packet;
    private final List<ItemStack> items;
    private final ItemStack carriedItem;

    public ClientboundSetContentsPacket_v1_21_R7(ClientboundContainerSetContentPacket packet) {
        this.packet = packet;
