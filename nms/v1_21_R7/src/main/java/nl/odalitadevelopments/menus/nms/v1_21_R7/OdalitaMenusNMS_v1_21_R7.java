package nl.odalitadevelopments.menus.nms.v1_21_R7;
...
import nl.odalitadevelopments.menus.nms.v1_21_R7.packet.ClientboundSetContentsPacket_v1_21_R7;
import nl.odalitadevelopments.menus.nms.v1_21_R7.packet.ClientboundSetSlotPacket_v1_21_R7;
...
public final class OdalitaMenusNMS_v1_21_R7 implements OdalitaMenusNMS {
    ...
    static {
        try {
            ...
            WINDOW_ID_FIELD = AbstractContainerMenu.class.getDeclaredField(ObfuscatedNames_v1_21_R7.WINDOW_ID);
            NETWORK_MANAGER_FIELD = ServerCommonPacketListenerImpl.class.getDeclaredField(ObfuscatedNames_v1_21_R7.NETWORK_MANAGER);
    ...
    public ClientboundSetSlotPacket readSetSlotPacket(Object packet) {
        ...
        return new ClientboundSetSlotPacket_v1_21_R7(clientboundContainerSetSlotPacket);
    }
    ...
    public ClientboundSetContentsPacket readSetContentsPacket(Object packet) {
        ...
        return new ClientboundSetContentsPacket_v1_21_R7(clientboundContainerSetContentPacket);
    }
