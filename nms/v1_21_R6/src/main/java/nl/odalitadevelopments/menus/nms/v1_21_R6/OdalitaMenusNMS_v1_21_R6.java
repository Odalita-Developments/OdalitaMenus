...
import nl.odalitadevelopments.menus.nms.v1_21_R6.packet.ClientboundSetContentsPacket_v1_21_R6;
import nl.odalitadevelopments.menus.nms.v1_21_R6.packet.ClientboundSetSlotPacket_v1_21_R6;
...
public final class OdalitaMenusNMS_v1_21_R6 implements OdalitaMenusNMS {
    ...
    static {
        try {
            ...
            WINDOW_ID_FIELD = AbstractContainerMenu.class.getDeclaredField(ObfuscatedNames_v1_21_R6.WINDOW_ID);
            NETWORK_MANAGER_FIELD = ServerCommonPacketListenerImpl.class.getDeclaredField(ObfuscatedNames_v1_21_R6.NETWORK_MANAGER);
    ...
    public ClientboundSetSlotPacket readSetSlotPacket(Object packet) {
        ...
        return new ClientboundSetSlotPacket_v1_21_R6(clientboundContainerSetSlotPacket);
    }
    ...
    public ClientboundSetContentsPacket readSetContentsPacket(Object packet) {
        ...
        return new ClientboundSetContentsPacket_v1_21_R6(clientboundContainerSetContentPacket);
    }
