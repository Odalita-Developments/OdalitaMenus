package nl.odalitadevelopments.menus.nms.v1_19_R3;
...
import nl.odalitadevelopments.menus.nms.v1_19_R3.packet.ClientboundSetContentsPacket_v1_19_R3;
import nl.odalitadevelopments.menus.nms.v1_19_R3.packet.ClientboundSetSlotPacket_v1_19_R3;
...
public final class OdalitaMenusNMS_v1_19_R3 implements OdalitaMenusNMS {
    ...
    static {
        try {
            ...
            WINDOW_ID_FIELD = AbstractContainerMenu.class.getDeclaredField(ObfuscatedNames_v1_19_R3.WINDOW_ID);
            NETWORK_MANAGER_FIELD = ServerGamePacketListenerImpl.class.getDeclaredField(ObfuscatedNames_v1_19_R3.NETWORK_MANAGER);
    ...
    public ClientboundSetSlotPacket readSetSlotPacket(Object packet) {
        ...
        return new ClientboundSetSlotPacket_v1_19_R3(clientboundContainerSetSlotPacket);
    }
    ...
    public ClientboundSetContentsPacket readSetContentsPacket(Object packet) {
        ...
        return new ClientboundSetContentsPacket_v1_19_R3(clientboundContainerSetContentPacket);
    }
