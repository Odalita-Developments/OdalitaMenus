package nl.odalitadevelopments.menus.nms.v1_19_R3.packet;
...
import nl.odalitadevelopments.menus.nms.v1_19_R3.ObfuscatedNames_v1_19_R3;
...
public final class ClientboundSetContentsPacket_v1_19_R3 implements ClientboundSetContentsPacket {
    ...
    static {
        ITEMS_FIELD = Reflections.getField(ClientboundContainerSetContentPacket.class, List.class, ObfuscatedNames_v1_19_R3.SET_CONTENTS_PACKET_ITEMS);
        CARRIED_ITEM_FIELD = Reflections.getField(ClientboundContainerSetContentPacket.class, net.minecraft.world.item.ItemStack.class, ObfuscatedNames_v1_19_R3.SET_CONTENTS_PACKET_CARRIED_ITEM);
    }
    ...
    public ClientboundSetContentsPacket_v1_19_R3(ClientboundContainerSetContentPacket packet) {
        this.packet = packet;
