...
public final class ClientboundSetSlotPacket_v1_20_R3 implements ClientboundSetSlotPacket {

    private static final Reflections.FieldAccessor<net.minecraft.world.item.ItemStack> ITEM_FIELD;

    static {
        ITEM_FIELD = Reflections.getField(ClientboundContainerSetSlotPacket.class, net.minecraft.world.item.ItemStack.class, ObfuscatedNames_v1_20_R3.SET_SLOT_PACKET_ITEM);
    }

    private final ClientboundContainerSetSlotPacket packet;
    private final ItemStack item;

    public ClientboundSetSlotPacket_v1_20_R3(ClientboundContainerSetSlotPacket packet) {
        this.packet = packet;
