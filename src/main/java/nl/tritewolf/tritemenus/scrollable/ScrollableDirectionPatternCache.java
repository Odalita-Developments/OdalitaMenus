...
record ScrollableDirectionPatternCache(ScrollableDirectionPattern.Direction patternDirection, List<String> pattern,
                                       NavigableMap<Integer, Integer> index, int height,
